...
def update_U(R, I, a=1e-05):
    ...
    for eachElement in range(R.shape[1]):
         user, label = extract_user_j(R[:,eachElement], I)
         train = train_user_j(user,label,a)
         
         U[eachElement] = train

    #the below code is hardcode - use as template
    #user1, label1 = extract_user_j(R[:,0], I)
    #user2, label2 = extract_user_j(R[:,1], I)
    #train1, train2 = train_user_j(user1,label1, a), train_user_j(user2,label2,a)
    #U = [train1, train2]
