...
def filter_batting(X, year):
    #########################################
    ## INSERT YOUR CODE HERE (3 points)
    X1 = X[X['yearID']==year] #needs the field on which we check for
    #########################################
    return X1
    #-----------------
    '''  
...
def group_batting(X1):
    #########################################
    ## INSERT YOUR CODE HERE (3 points)
    X2 = group_sum(X1,'playerID') #we can just use the group sum function created earlier
    #########################################
    return X2
    #-----------------
    '''  
...
def merge_player(X2, Y):
    #########################################
    ## INSERT YOUR CODE HERE (3 points)
    X3 = merge(X2,Y,'playerID') #use the merge function
    #########################################
    return X3
    #-----------------
    '''  
...
def filter_salary(Z, year):
    #########################################
    ## INSERT YOUR CODE HERE (3 points)
    Z1 = Z[Z['yearID']==year] #could call filter_batting here to get same result, just doesnt make much sense
    #########################################
    return Z1
    #-----------------
    '''  
...
def merge_salary(X3, Z1):
    #########################################
    ## INSERT YOUR CODE HERE (3 points)
    X4 = merge(X3, Z1, 'playerID') #could use merge_player here but it doesnt make much sense
    #########################################
    return X4
    #-----------------
    '''  
