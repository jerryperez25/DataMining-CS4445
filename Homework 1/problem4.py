...
def compute_players_BA(X6):
    ...
    X6.insert(len(X6.columns),'BA',X6['H']/X6['AB'], allow_duplicates = False) # location is user preference
    #########################################
    #-----------------
    '''  
...
def compute_players_OBP(X7):
    #########################################
    ## INSERT YOUR CODE HERE (4 points)
    X7.insert(len(X7.columns), 'OBP', (X7['H'] + X7['BB'] + X7['HBP'])/(X7['AB']+X7['BB']+X7['HBP']+X7['SF']), allow_duplicates=False)
    #########################################
    #-----------------
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
...
def compute_players_1B(X8):
    #########################################
    ## INSERT YOUR CODE HERE (3 points)
    X8.insert(len(X8.columns), '1B', (X8['H'] - (X8['2B'] + X8['3B']+ X8['HR'])), allow_duplicates=False)
    #########################################
    #-----------------
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
...
def compute_players_TB(X9):
    #########################################
    ## INSERT YOUR CODE HERE (3 points)
    X9.insert(len(X9.columns), 'TB', (X9['1B'])+(2*X9['2B'])+(3*X9['3B'])+(4*X9['HR']), allow_duplicates=False)
    #########################################
    #-----------------
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
...
def compute_players_SLG(X10):
    #########################################
    ## INSERT YOUR CODE HERE (4 points)
    X10.insert(len(X10.columns), 'SLG',X10['TB']/X10['AB'], allow_duplicates=False)
    #########################################
    #-----------------
    '''  
        TEST: Now you can test the correctness of your code above by typing the following in the terminal:
