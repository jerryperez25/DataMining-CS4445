...
def compute_BA(H, AB):
    ...
    BA = H/AB #Batting Average is calculated by Hits divided by total at bats
...
def compute_OBP(H, AB, BB, HBP, SF):
    #########################################
    ## INSERT YOUR CODE HERE (3 points)
    #the OBP can be found by using: (Hits+Walks+HitByPitch)/(AtBats+Walks+HitByPitch+SacrificeFlies)
